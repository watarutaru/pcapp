...
const styles = StyleSheet.create({
  ...
  errorText: { color: Colors.textSecondary, fontSize: 16, textAlign: 'center', paddingHorizontal: 40 },
  camera: { flex: 1 },
  overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  topBar: { position: 'absolute', top: 60, left: 24, right: 24 },
  backBtn: { alignSelf: 'flex-start' },
  backBtnText: { color: '#fff', fontSize: 16 },
  instruction: { color: '#fff', fontSize: 15, marginBottom: 40, textAlign: 'center', paddingHorizontal: 40 },
  ...
  backBtn2: { marginBottom: 8 },
  backBtnText2: { color: Colors.primary, fontSize: 16 },
